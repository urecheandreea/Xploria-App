...
var vt = class _vt {
  ...
  next(t, e) {
    return this.callbackAttached && $(), this.callbackAttached = true, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new _vt((n, s) => {
  ...
  wrapUserFunction(t) {
    try {
      const e = t();
      return e instanceof _vt ? e : _vt.resolve(e);
    } catch (t2) {
      return _vt.reject(t2);
    }
  }
  wrapSuccess(t, e) {
    return t ? this.wrapUserFunction(() => t(e)) : _vt.resolve(e);
  }
  wrapFailure(t, e) {
    return t ? this.wrapUserFunction(() => t(e)) : _vt.reject(e);
  }
  static resolve(t) {
    return new _vt((e, n) => {
      e(t);
   ...
   */
  static or(t) {
    let e = _vt.resolve(false);
    for (const n of t)
      e = e.next((t2) => t2 ? _vt.resolve(t2) : n());
    return e;
  }
  static forEach(t, e) {
    const n = [];
...
var bt = class _bt {
  ...
  static C() {
    var t;
    return "undefined" != typeof import_process.default && "YES" === (null === (t = import_process.default.env) || void 0 === t ? void 0 : t.k);
  }
...
var $e = class _$e {
  ...
  isEqual(t) {
    return t instanceof _$e && t.projectId === this.projectId && t.database === this.database;
  }
};
var Fe = {
  mapValue: {
...
var _i = class __i {
  ...
  static create(t, e, n) {
    const s = t % 8 == 0 ? 0 : 8 - t % 8, i = new Uint8Array(Math.ceil(t / 8)), r2 = new __i(i, s, e);
...
var Jo = class _Jo {
  constructor(t, e, n, s, i, r2, o, u, c, a, h = 15) {
    ...
    this.li = (t2) => Promise.resolve(), !_Jo.D())
...
var Ru = class _Ru {
  ...
  static cr(t) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new _Ru(e.clientId, e.onlineState) : (k2("SharedClientState", `Failed to parse online state: ${t}`), null);
  }
};
var vu = class {
  constructor() {
...
var lh = class _lh {
  ...
  withConverter(t) {
    return new _lh(this.firestore, t, this._key);
  }
};
var fh = class _fh {
  ...
  withConverter(t) {
    return new _fh(this.firestore, t, this._query);
  }
};
var dh = class _dh extends fh {
  /** @hideconstructor */
  constructor(t, e, n) {
  ...
  withConverter(t) {
    return new _dh(this.firestore, t, this._path);
  }
};
function _h(t, e, ...n) {
...
var qh = class _qh {
  ...
  static fromBase64String(t) {
    try {
      return new _qh(Ve.fromBase64String(t));
    } catch (t2) {
   ...
   */
  static fromUint8Array(t) {
    return new _qh(Ve.fromUint8Array(t));
  }
  /**
...
var Jh = class _Jh {
  ...
  ca(t) {
    return new _Jh(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  aa(t) {
    var e;
...
var nl = class _nl extends Gh {
  _toFieldTransform(t) {
    return new Ms(t.path, new bs());
  }
  isEqual(t) {
    return t instanceof _nl;
  }
};
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-57RBQBYW.js.map
