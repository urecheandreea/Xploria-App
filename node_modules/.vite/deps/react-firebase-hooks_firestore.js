...
import {
  ...
  pf,
  yh
} from "./chunk-57RBQBYW.js";
import "./chunk-IGQPSSEB.js";
import {
  __toESM,
  init_shim
...
var useCollection = function(query, options) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    var unsubscribe = (options === null || options === void 0 ? void 0 : options.snapshotListenOptions) ? pf(ref.current, options.snapshotListenOptions, setValue, setError) : pf(ref.current, setValue, setError);
    return function() {
      unsubscribe();
    };
  }, [ref.current]);
